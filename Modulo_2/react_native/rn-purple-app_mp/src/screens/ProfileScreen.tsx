    ...
    <InventoryGradientBg>
      <View style={{ flex:1, padding:16, gap:12 }}>
        <GlassCard style={{ alignItems:"center" }}>
          ...
          />
          <Text style={{ color:"#fff", fontSize:20, fontWeight:"700" }}>Administrador</Text>
          <Text style={{ color:"#cfd" }}>{email ?? "user@example.com"}</Text>
        </GlassCard>

        <GlassCard>
          <Text style={{ color:"#fff", marginBottom:8 }}>Tus métricas de inventario</Text>
          <Text style={{ color:"#ddd" }}>
            Productos: 124 — Stock bajo: 7 — Órdenes pendientes: 15
          </Text>
        </GlassCard>
