  ...
  return (
    <InventoryGradientBg>
      <View style={{ flex:1, padding: 12 }}>
        ...
        >
          <Text style={{ color: colors.primary }}>+ Nuevo producto</Text>
        </Pressable>
        ...
        <FlatList
          ...
          renderItem={({ item }) => (
            <GlassCard>
              ...
              <Text style={{ color: colors.subtle }} numberOfLines={2}>Cantidad: {item.quantity ?? 0}</Text>
              ...
              <View style={{ flexDirection:"row", gap:10, marginTop:10 }}>
                ...
                <Pressable
                  onPress={() => {
                    Alert.alert("Eliminar producto", "¿Seguro que deseas eliminarlo?", [
